    ...
    <div class="wrapper">
        ...
        <ul class="navigation">
            ...
            <?php if (Session::userIsLoggedIn()) { ?>
                <li <?php if (View::checkForActiveController($filename, "watchlist")) { echo ' class="active" '; } ?> >
                    <a href="<?php echo Config::get('URL'); ?>watchlist/index">Watchlist</a>
                </li>
                <li <?php if (View::checkForActiveController($filename, "note")) { echo ' class="active" '; } ?> >
                    <a href="<?php echo Config::get('URL'); ?>note/index">My Notes</a>
                </li>
                <li <?php if (View::checkForActiveController($filename, "movies")) { echo ' class="active" '; } ?> >
                    <a href="<?php echo Config::get('URL'); ?>movie/index">movies</a>
                </li>
            <?php } else { ?>
